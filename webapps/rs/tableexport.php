...
<!-- include navbar -->
    ...
    <div class="container">
        ...
        <div class="row mt-3">
                     <!-- Tambahkan tombol untuk ekspor ke Excel -->
                    <a href="exportexcel.php" class="btn btn-secondary pdf" target="_blank">Export to Excel</a> 
                    <!-- Tambahkan tombol untuk ekspor ke PDF -->
                    <a href="exportpdf.php" class="btn btn-danger pdf" target="_blank">Export to PDF</a> 
            <div class="col-lg-12">
