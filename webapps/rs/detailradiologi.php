...
<body style="font-family: 'Poppins', sans-serif;color: black;">
    ...
    <div class="container-xl">
        <div class="row">
            <h2 class="mt-3">DETAIL TINDAKAN <span class="text-warning">RADIOLOGI</span></h2>
        </div>
        <br>
        <div class="row mt-1">
            <div class="col-lg-12">
                ...
                <table class="table table-light table-hover table-striped text-black-50 table-responsive" id="chuakss">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th scope="col" class="bg-info text-light">DOKTER PJ RDL</th>
                            <th scope="col" class="bg-info text-light">NIP</th>
                            <th scope="col" class="bg-info text-light">PETUGAS RDL</th>
                            ...
                            <th scope="col" class="bg-info text-light">JM.PJ.RDL</th>
