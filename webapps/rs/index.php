    ...
    <div class='container'>
        ...
        <div class='row'>
            <div class='list-group'>
                ...
                <a href='rawatjalan.php' class='list-group-item list-group-item-action list-group-item-success'>CATATAN SOAP</a>
                ...
                <a href='?aksi=Keluar' class='list-group-item list-group-item-action list-group-item-danger'>KELUAR</a>
            </div>
        </div>
    </div>";
}else{
     ...
     if (isset($BtnLogin)) {
        ...
        <div class=\"row justify-content-center\">
            <div class=\"col-4 bg-white p-5 rounded-start rounded-4\">
                <div class=\"p-3 bg-white border-0\">
                    <form id=\"pengenmasuk-form\" role=\"form\" onsubmit=\"return validasi();\" method=\"post\" action=\"\" enctype=multipart/form-data>
                        ...
                        <div class=\"mb-3 text-center\">
                            <input type=\"submit\"  name=\"BtnLogin\" class=\"btn btn-login border-success border-3 text-center rounded-pill\" value=\"Login\" style=\"width:70%;color:#5cb85c;\">
                        </div>
                    </form>
                </div>
            </div>
