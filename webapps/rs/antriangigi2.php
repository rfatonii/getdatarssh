            ...
            <div class="col-12">
                <div class="card p-4 shadow" style="background-color:#4cda9f; color: white;">
                    <table style="font-size:18px;">
                        ...
                        <tr><td>No. Antrian</td><td>:</td><td><span id="no-rawat"></td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        if ($konektor && $result && mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($row['stts'] === 'Belum') {
                    ...
                    echo '<button type="button" name="panggil" class="btn btn-outline-primary tampilkan-btn" onclick="playPoli(this);" data-nomor-registrasi="' . $row['no_reg'] . '" data-nama-dokter="' . $row['nm_dokter'] . '"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-volume-down" viewBox="0 0 16 16">
        ...
        <footer width='100'>
            <div class="container">
                ...
                <div class="col-12 footer m-auto text-light">
                    ...
                    <div class="col-10">
                        <marquee behavior="" direction=""><span>Hai syahid lovers... berikut adalah beberapa tips sederhana untuk menjaga kesehatan gigi: 
                            1. Menyikat Gigi Secara Teratur: Sikat gigi setidaknya dua kali sehari, pagi dan malam sebelum tidur, dengan pasta gigi yang mengandung fluoride. Sikat dengan gerakan memutar dan bersihkan setiap permukaan gigi, termasuk di belakang gigi.
                            2. Perhatikan Pola Makan: Batasi konsumsi makanan dan minuman manis serta asam, karena dapat menyebabkan kerusakan gigi. Pilih makanan yang sehat dan kaya akan kalsium, seperti susu, keju, dan sayuran hijau.
                            3. Minum Air Secara Teratur: Air membantu membersihkan sisa makanan di mulut dan meminimalkan produksi asam yang dapat merusak gigi.
                            4. Kunjungi Dokter Gigi secara Berkala: Rutin berkonsultasi dengan dokter gigi setidaknya dua kali setahun untuk pemeriksaan gigi dan pembersihan profesional. Ini membantu mencegah masalah gigi dan gusi lebih awal.
                            5. Hindari Kebiasaan Merokok dan Mengunyah Tembakau: Kebiasaan ini tidak hanya buruk bagi kesehatan umum, tetapi juga dapat menyebabkan masalah serius pada gigi dan mulut, seperti kanker mulut dan kerusakan gusi.</span></marquee>
                    </div>
                    <div class="col-1"> 
